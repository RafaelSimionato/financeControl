...
<body>
    <div>
        <?php
            ...
            echo "<h1> Over Brits Pond </h1>";            
            echo "<h3> GBP (Groot Brits Pond) <br>x<br> EUR (Euro) </h3> ";
            echo "<br>";
            echo "&pound; 01 Pond is gelijk aan ongeveer &euro; ";
            ...
            if ($finance['currencies']['GBP']['variation'] > 0) {
                echo "Waarde stijgt ";
                echo "<font color='#00d200'>$var4 </font> % ";
                
            } elseif ($finance['currencies']['GBP']['variation'] == 0) {
                echo "Stabiele variatie in ";
                echo "<font color='#303b3b'>$var4 </font> % <br><br>";
                echo "Geen significante beweging <br> ";
            } else {
                echo "Dalende waarde ";
                echo "<font color='#d01515'>$var4 </font> % ";
            }                   
            echo "<br><br> ";
            echo "<fieldset><div id='gbp'><p>Pond, is de officiële valuta die wordt gebruikt in het Verenigd Koninkrijk </p>
            </div></fieldset> ";
        ?> <br>
